...
--LOGS DE FOTOGRAFIAS
Config.Webhook = "TU WEBHOOK HUEVON"

--LOGS DE SECCION AMARILLA
Config.YellowWebbook = "TU WEBHOOK HUEVON"

--LOGS DE SECCION TWITTER
Config.TwitterWebbook = "TU WEBHOOK HUEVON"
...
FixePhone = {
  ...
  ['008-0001'] = { name = "Cabinas Telefonicas", coords = { x = 372.25, y = -965.75, z = 28.58 } },
}
...
Config.newsBlip = vector3(-594.04437255859, -929.59808349609, 28.8176612854) 
Config.valetPrice = 100
Config.uberPriceMultiplier = 1.5 
Config.uberTipMin = 500 
Config.uberTipMax = 1000
